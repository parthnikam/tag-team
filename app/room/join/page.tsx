          ...
          <div className="mt-8 flex flex-col gap-6">
            <label className="flex flex-col gap-2">
              ...
              <input
                ...
                className="w-full rounded-full border border-[#E7E7E7] px-5 py-3 text-center text-[1.15rem] tracking-[0.28em] text-[#475467] outline-none transition-colors placeholder:text-[#667085] focus:border-[#0A0A0A]"
                placeholder="123456"
                maxLength={6}
              />
            </label>
            ...
            <button
              ...
              className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-[#0A0A0A] px-7 py-3.5 text-[1rem] font-semibold text-white transition-colors disabled:opacity-50"
            >
